        ...
        <div class="w-full md:w-1/2">
            <div class="bg-white/90 shadow-xl rounded-xl overflow-hidden backdrop-blur-lg border border-white/20">
                <div class="bg-gradient-to-r from-[#02311a] to-[#0cad56] text-white text-center py-6 px-4 relative">
                    ...
                    <p class="text-white/80 text-xs relative">Bienvenido de vuelta a tu espacio personal</p>
                ...
                <form method="POST" action="{{ route('login') }}" class="p-6 space-y-4">
                    ...
                    <div class="flex items-center justify-between">
                        <label class="flex items-center space-x-2 cursor-pointer group">
                            ...
                            >
                            <span class="text-gray-600 text-xs group-hover:text-gray-800 transition-colors duration-300">Recuérdame</span>
                        </label>
                    ...
                    <button 
                        type="submit" 
                        class="w-full bg-gradient-to-r from-[#0cad56] to-[#02311a] text-white py-2.5 rounded-lg hover:opacity-95 transition-all duration-300 transform hover:scale-[1.02] shadow-lg relative overflow-hidden group text-sm"
                    >
