...
<div class="min-h-screen bg-gradient-to-br from-[#f8f9fa] to-[#e9ecef] py-4 px-2">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="text-center mb-8 relative">
            ...
            <p class="text-gray-600 mt-2 text-lg">Gestiona los accesos de tu equipo de publicación</p>
        </div>
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                <div class="bg-gradient-to-r from-[#02311a] to-[#0cad56] p-4">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h2 class="text-xl font-bold text-white">Nuevo Publicador</h2>
                            <p class="text-white/80 text-sm">Complete el formulario para crear una nueva cuenta</p>
                        </div>
                    </div>
                </div>

                <form method="POST" action="{{ route('admin.createUser') }}" class="p-6 space-y-5">
                    @csrf
